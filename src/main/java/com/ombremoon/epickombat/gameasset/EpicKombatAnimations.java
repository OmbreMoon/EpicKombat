...
public class EpicKombatAnimations {
    ...
    private static void build() {
        ...
        RUSHING_TEMPO2 = new ComboAttackAnimation(0.05F, 0.0F, 0.15F, 0.25F, 0.6F, null, biped.toolR, "biped/skill/rushing_tempo2", biped)
                .addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
                .addProperty(AnimationProperty.AttackAnimationProperty.EXTRA_COLLIDERS, 2)
                .addProperty(AnimationProperty.ActionAnimationProperty.RESET_PLAYER_COMBO_COUNTER, false)
                .newTimePair(0.0F, 0.25F);
        RUSHING_TEMPO3 = new ComboAttackAnimation(0.05F, 0.0F, 0.2F, 0.25F, 0.6F, null, biped.toolR, "biped/skill/rushing_tempo3", biped)
                .addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.6F)
                .addProperty(AnimationProperty.AttackAnimationProperty.EXTRA_COLLIDERS, 2)
                .addProperty(AnimationProperty.ActionAnimationProperty.RESET_PLAYER_COMBO_COUNTER, false)
                .newTimePair(0.0F, 0.25F);
        UCHIGATANA_AUTO1 = (new ComboBasicAttackAnimation(0.05F, 0.15F, 0.25F, 0.3F, (Collider)null, biped.toolR, "biped/combat/uchigatana_auto1", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.0F);
        UCHIGATANA_AUTO2 = (new ComboBasicAttackAnimation(0.05F, 0.2F, 0.3F, 0.3F, (Collider)null, biped.toolR, "biped/combat/uchigatana_auto2", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.0F);
        UCHIGATANA_AUTO3 = (new ComboBasicAttackAnimation(0.1F, 0.15F, 0.25F, 0.5F, (Collider)null, biped.toolR, "biped/combat/uchigatana_auto3", biped)).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 2.0F);
    }
}
